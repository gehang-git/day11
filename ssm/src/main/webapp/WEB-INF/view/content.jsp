        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">广告标题名称</span>
			      <input type="text" name="contenttitle" class="form-control" id="contenttitle_search" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">广告分类</span>
					<select class="form-control" name="contentcategoryid" id = "contentcategoryid_search">
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            contenttitle: $("#contenttitle_search").val(),
	            contentcategoryid: $("#contentcategoryid_search").val(),
